...
class SpeciesService(
    ...
    fun createSpecies(request: CreateSpeciesRequest, orgId: Long): SpeciesResponse {
        val species = speciesRepository.persist(
            Species(
                ...
                germinationTimeDaysMin = request.germinationTimeDaysMin,
                germinationTimeDaysMax = request.germinationTimeDaysMax,
                daysToHarvestMin = request.daysToHarvestMin,
                daysToHarvestMax = request.daysToHarvestMax,
                sowingDepthMm = request.sowingDepthMm,
                growingPositions = request.growingPositions ?: emptyList(),
                soils = request.soils ?: emptyList(),
                heightCmMin = request.heightCmMin,
                heightCmMax = request.heightCmMax,
    ...
    fun updateSpecies(speciesId: Long, request: UpdateSpeciesRequest, orgId: Long): SpeciesResponse {
        ...
        val updated = species.copy(
            ...
            germinationTimeDaysMin = request.germinationTimeDaysMin ?: species.germinationTimeDaysMin,
            germinationTimeDaysMax = request.germinationTimeDaysMax ?: species.germinationTimeDaysMax,
            daysToHarvestMin = request.daysToHarvestMin ?: species.daysToHarvestMin,
            daysToHarvestMax = request.daysToHarvestMax ?: species.daysToHarvestMax,
            ...
            heightCmMin = request.heightCmMin ?: species.heightCmMin,
            heightCmMax = request.heightCmMax ?: species.heightCmMax,
        ...
        for (entry in entries) {
            ...
            val species = speciesRepository.persist(
                Species(
                    ...
                    germinationTimeDaysMin = entry.germinationTimeDaysMin,
                    germinationTimeDaysMax = entry.germinationTimeDaysMax,
                    daysToHarvestMin = entry.daysToHarvestMin,
                    daysToHarvestMax = entry.daysToHarvestMax,
                    ...
                    heightCmMin = entry.heightCmMin,
                    heightCmMax = entry.heightCmMax,
    ...
    private fun Species.toResponse(
        ...
        return SpeciesResponse(
            ...
            germinationTimeDaysMin = germinationTimeDaysMin,
            germinationTimeDaysMax = germinationTimeDaysMax,
