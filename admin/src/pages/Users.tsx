...
export default function Users() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-2xl font-semibold text-[#37352F]">Users</h2>
        <p className="text-sm text-[#787774] mt-1">{users?.length || 0} registered users</p>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-[#E9E9E7] bg-[#FBFBFA]">
              ...
              <th className="text-left px-4 py-2 text-xs font-medium text-[#787774] uppercase tracking-wider">Email</th>
              <th className="text-left px-4 py-2 text-xs font-medium text-[#787774] uppercase tracking-wider">Role</th>
              <th className="text-left px-4 py-2 text-xs font-medium text-[#787774] uppercase tracking-wider">Joined</th>
