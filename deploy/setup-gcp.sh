...
echo ""
echo "Create JWT key secrets (generate keys first if needed):"
echo "  openssl genrsa -out privateKey.pem 2048"
echo "  openssl rsa -in privateKey.pem -pubout -out publicKey.pem"
echo "  gcloud secrets create verdant-jwt-private-key --data-file=privateKey.pem"
echo "  gcloud secrets create verdant-jwt-public-key --data-file=publicKey.pem"
echo ""
